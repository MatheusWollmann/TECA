...
const App: React.FC = () => {
  ...
  const renderContent = () => {
    ...
    switch (currentPage) {
      case Page.Home: return <HomeScreen user={user} dailyPrayer={prayers[1] ?? prayers[0] ?? null} circulos={circulos} prayers={prayers} onSelectPrayer={handleSelectPrayer} onSelectCirculo={handleSelectCirculo} onRemoveScheduledPrayer={handleRemoveScheduledPrayer} onToggleScheduledPrayer={handleToggleScheduledPrayer} onPostReaction={handlePostReaction} />;
